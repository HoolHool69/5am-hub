...
if not __game_registered_1 then
    error(string.format("5AM game module registration failed for PlaceId 89035794510548: %s", tostring(__game_registration_error_1)), 0)
end
...
if not __game_registered_2 then
    error(string.format("5AM game module registration failed for PlaceId 113191263362278: %s", tostring(__game_registration_error_2)), 0)
end
